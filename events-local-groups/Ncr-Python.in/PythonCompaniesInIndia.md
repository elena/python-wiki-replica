This is a page taken up from [BangPypers](https://github.com/elena/python-wiki-replica/blob/main/events-local-groups/BangPypers) page , will try to update it as and when i learn about companies and 
